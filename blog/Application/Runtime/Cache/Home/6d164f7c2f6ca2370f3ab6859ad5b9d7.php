    ...
    <div id="content">
       <!--left-->
         <div class="left" id="learn" style="width: 100%;">
           ...
           <br>
           <span id="ngehe" data-target="#modal2" style="cursor: pointer; margin-top: 6px; background-color: #39AECF;" onclick="dialog();">写博客</span>

           <div class="center bzm-content" id="modal2" data-title="发表博客">
            <div class="register">
              <div class="regMain">
                <div class="regUser">
                  <form action="/blog/index.php/Home/Blog/addBlog" id="regForm" autocomplete="off" method="post" enctype="multipart/form-data">
                    <div class="regList">
                      <div class="listTop">
                        <span>类型：</span>
                        <input type="text" name="username" placeholder="" value="<?php echo ($classifyname); ?>" readonly="readonly">
                        <input type="hidden" value="<?php echo ($classify); ?>" name="classify"></input>
                      </div>
              ...
              <table class="table table-hover">
                <tbody>
                  <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td style="width: 60%;"><a href="http://localhost/blog/index.php/Home/Blog/detail?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
                      <td style="width: 10%;"><?php echo ($vo["classify"]); ?></td>
                      <td style="width: 10%;"><?php echo ($vo["username"]); ?></td>
                      <td style="width: 20%;"><?php echo ($vo["createtime"]); ?></td>
