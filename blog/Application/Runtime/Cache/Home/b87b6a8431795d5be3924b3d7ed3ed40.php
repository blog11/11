...
<link rel="stylesheet" href="/blog/Public/css/animate.css"/>
<style type="text/css">
    ...
    <!--nav-->
     <div id="nav">
        <ul>
         ...
         <li><a id="nava" href="/blog/index.php/Home/Dialog/index">漫生活</a></li>
    ...
    <div id="content">
       <!--left-->
         <div class="left" id="riji">
           <div class="weizi">
           <div class="wz_text">当前位置：<a href="#">首页</a>><h1>漫生活</h1></div>
           </div>
           <div class="rj_content">
              <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--时光-->
                <div class="shiguang animated bounceIn">
                  <div class="left sg_ico">
                  <img src="/blog/Public/images/about/my_1.jpg" width="120" height="120" alt=""/>
                  </div>
                  <div class="right sg_text">
                  <img src="/blog/Public/images/about/left.png" width="13" height="16" alt="左图标"/>
                          <h4><?php echo ($vo["title"]); ?></h4><br><?php echo ($vo["content"]); ?><span style="position: absolute;margin-top: 60px; margin-left: 180px;"><?php echo ($vo["createtime"]); ?></span>
                  </div>
                  <div class="clear"></div>
                </div>
                <!--时光 end--><?php endforeach; endif; else: echo "" ;endif; ?>
                
               
              
           </div>
           <span class="pages"><?php echo ($page); ?></span>
         </div>
         <!--end left -->
         <!--right-->
